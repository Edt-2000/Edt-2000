...
export class SocketService {
    ...
    sendVidtPreset(preset: string) {
        this.toSledt(Actions.prepareVidt(VidtPresets[preset as keyof typeof VidtPresets]));
    }
    ...
    sendAnimation(animation: string) {
        this.toSledt(Actions.animationType(AnimationTypes[animation as keyof typeof AnimationTypes]));
    }
    ...
    sendLaunchpadTrigger(launchpadTrigger: LaunchpadTrigger) {
        if(launchpadTrigger.triggerAction) this.toSledt(launchpadTrigger.triggerAction);
    }
