import { OSC$ } from "./osc";
import {
    convertOSCToMIDICCMessage,
    convertOSCToMIDINoteMessage,
    convertOSCToMidiSongMessage,
    isMidiCCMessage,
    isMidiMessage,
    isMidiNoteMessage,
    isMidiSongMessage,
} from "../../../Shared/midi/midi";
import { automationChannel } from "../../config/config";
import {
    IMidiCCMsg,
    IMidiNoteMsg,
    IMidiSongMsg,
} from "../../../Shared/midi/types";
import { filter, map, Observable } from "rxjs";

const midiOSC$ = OSC$.pipe(filter(isMidiMessage));
